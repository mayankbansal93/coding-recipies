...
public class FivePercentTaxWith300KLimitCommandExecutor extends SalaryCommandExecutor {
    @Override
    protected SalaryResponse executeValidCommand(Salary salary) {
        return new SalaryResponse(0.05 * Math.min(200000, salary.getAmount() - 300000));
    }

    @Override
    public Boolean isApplicable(Request request) {
        return ((Salary) request).getAmount() > 300000;
    }
}
